...
var forms = function forms() {
    ...
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            document.querySelector('.newBlock').textContent = message.loading;
            _context.next = 3;
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      subMessage.classList.add('.newBlock');
      item.appendChild(subMessage);
      var formdata = new FormData(item);
      postData('assets/server.php', formdata).then(function (res) {
        console.log(res);
        subMessage.textContent = message.succes;
      }).catch(function () {
        return subMessage.textContent = message.failure;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
          subMessage.remove();
...
var modals = function modals() {
  var bindModal = function bindModal(triggerSelector, contentSelector, closeSelector) {
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, active) {
